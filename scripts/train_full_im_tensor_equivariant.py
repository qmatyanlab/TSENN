...
run_name = f'with_equivariant_model_im_{run_time}'
...
cart_true = np.stack(df['imag_Permittivity_Matrices_interp'].values)  # Shape: (num_samples, 201, 3, 3)
...
print(f"Prediction completed. MSE Cart: {mse_cart_mean:.4f} ± {mse_cart_std:.4f}, "
      f"MSE Sph: {mse_sph_mean:.4f} ± {mse_sph_std:.4f}")
